...
const threeOfKind = new SumDistro({ count: 3, description: 'Sum all dice if three are same' });
const fourOfKind = new SumDistro({ count: 4, description: 'Sum all dice if four are same' });
